webpackJsonp([0,5],Array(23).concat([
/* 23 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__service_getData__ = __webpack_require__(28);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
	...
	mounted() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__service_getData__["a" /* daymusic */])().then(res => {
			this.musiclist = res;
		});
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__service_getData__["b" /* types */])().then(res => {
			this.types = res;
		});
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__service_getData__["c" /* hotpush */])().then(res => {
			this.hotpush = res;
		});
	}
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tempdata_music__ = __webpack_require__(29);
...
const daymusic = () => setPromise(__WEBPACK_IMPORTED_MODULE_0__tempdata_music__["a" /* daymusic */]);
/* harmony export (immutable) */ __webpack_exports__["a"] = daymusic;

const types = () => setPromise(__WEBPACK_IMPORTED_MODULE_0__tempdata_music__["b" /* types */]);
/* harmony export (immutable) */ __webpack_exports__["b"] = types;

const hotpush = () => setPromise(__WEBPACK_IMPORTED_MODULE_0__tempdata_music__["c" /* hotpush */]);
/* harmony export (immutable) */ __webpack_exports__["c"] = hotpush;
...
const daymusic = [{
	name: "I Can't Change",
	desc: "Sophie Zeimani ; A Decade of Dream..."
}, {
	name: "鸽子吧",
	desc: "尧十三 麻油叶？不叫事儿!"
}, {
	name: "Dance Magic",
	desc: "SRebecca Shiochet/Ashleigh Bail/Shan..."
}, {
	name: "不说出的温柔",
	desc: "范逸臣 不说出的温柔"
}, {
	name: "我们的明天",
	desc: "鹿晗 重返20岁 电影原声带 《重返20..."
}];
/* harmony export (immutable) */ __webpack_exports__["a"] = daymusic;
...
const types = ["歌手", "排行", "电台", "分类歌单", "视频MV", "数字专辑"];
/* harmony export (immutable) */ __webpack_exports__["b"] = types;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('ul', _vm._l((_vm.types), function(item) {
    return _c('li', [_c('span', [_vm._v(_vm._s(item))])])
  }))]), _vm._v(" "), _c('div', {
    attrs: {
      "id": "hot-push"
    }
  ...
  }, [_vm._v(" > ")]), _vm._v(" "), _vm._l((_vm.hotpush), function(item, index) {
    return _c('a', [_c('figure', [(index == 0) ? _c('img', {
      attrs: {
        "src": __webpack_require__(39)
      }
    }) : _vm._e(), _vm._v(" "), (index == 1) ? _c('img', {
      attrs: {
        "src": __webpack_require__(40)
      }
    }) : _vm._e(), _vm._v(" "), (index == 2) ? _c('img', {
      attrs: {
        "src": __webpack_require__(41)
      }
    }) : _vm._e(), _vm._v(" "), (index == 3) ? _c('img', {
      attrs: {
    ...
    }) : _vm._e(), _vm._v(" "), (index == 5) ? _c('img', {
      attrs: {
        "src": __webpack_require__(44)
      }
    }) : _vm._e(), _vm._v(" "), _c('figcaption', [_vm._v(_vm._s(item.name))])])])
  })], 2), _vm._v(" "), _c('div', {
    attrs: {
      "id": "day30"
    }
    ...
    return _c('li', [_c('section', [(index == 0) ? _c('img', {
      attrs: {
    ...
    }) : _vm._e()]), _vm._v(" "), _c('section', [_c('div', [_c('h6', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('p', [_vm._v(_vm._s(item.desc))])])])])
  }))])])])
...
var update = __webpack_require__(7)("3a836fb0", content, false);
